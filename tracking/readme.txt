...
# Important note: The loop_track.m is designed for analyzing large videos. For this particular sample_vid.avi it gives error while saving the last file which can be ignored and the remaining data may be stitched using meta_analysis.m. This is because the length of the video is small.
